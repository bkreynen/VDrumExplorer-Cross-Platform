...
namespace VDrumExplorer.ViewModel.Test.Home
{
    public class ExplorerHomeViewModelTest
    {
        ...
        internal static DeviceViewModel CreateDeviceViewModelWithFakeDevice(ModuleIdentifier? identifier = null)
        {
            ...
            var client = ViewModel.Test.Helpers.ViewModelTestHelpers.CreateFakeRolandClient(input, output, "Test MIDI", 0x10, identifier);
            var controller = ViewModel.Test.Helpers.ViewModelTestHelpers.CreateDeviceController(client, NullLogger.Instance);
